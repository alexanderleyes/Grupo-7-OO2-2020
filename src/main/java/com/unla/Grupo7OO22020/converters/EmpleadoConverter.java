...
public class EmpleadoConverter {
	...
	public EmpleadoModel entityToModel(Empleado empleado) {
		return new EmpleadoModel(empleado.getIdPersona(),
				empleado.getNombre(),
				...
				empleado.getHorasXjornada(),
				empleado.getPlusSueldo());
	}
	
	public Empleado modelToEntity(EmpleadoModel empleadoModel) {
		return new Empleado(empleadoModel.getIdPersona(),
				empleadoModel.getNombre(),
				empleadoModel.getApellido(),
				empleadoModel.getFechaNacimiento(),
				empleadoModel.getDni(),
				/**/ empleadoModel.getUsuario(),
				empleadoModel.getPassword(),
				empleadoModel.getHoraIngreso(),
				empleadoModel.getHorasXjornada(),
				empleadoModel.getPlusSueldo(),
				empleadoModel.isBaja());
	}
}
