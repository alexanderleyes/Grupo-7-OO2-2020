...
public class VendedorConverter {
	...
	public VendedorModel entityToModel(Vendedor vendedor) {
		return new VendedorModel(vendedor.getIdPersona(),  vendedor.getNombre(), vendedor.getApellido(), vendedor.getFechaNacimiento(), vendedor.getDni(), vendedor.getIdPersona(), vendedor.getUsuario(), vendedor.getPassword(), vendedor.getHoraIngreso(),
